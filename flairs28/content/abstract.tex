...
During these tasks, students and researchers commonly look search for
documents based on particular themes.
We use a popular topic modeling algorithm, Latent Dirichlet Allocation,
to derive topic distributions for articles.
We allow users to specify personal topic distribution to 
